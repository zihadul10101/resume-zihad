        ...
        <section id="resume" className="border border-red-500 p-6 bg-white  overflow-hidden">
            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="mx-auto flex justify-center p-10">
                    <button onClick={() => { setEdu('education'); setExp('') }} className="bg-indigo-500 mx-6 my-3 p-3">Experience</button>
                    <button onClick={() => { setExp('exprience'); setEdu(''); }} className="bg-indigo-500 mx-6 my-3 p-3">Education</button>
                </div>
{ 
...
edu === 'education'? <div className=" w-full flex justify-center items-center">
     <div className="max-w-7xl mx-auto w-full grid grid-cols-9 px-2">
        ...
        <div className="col-span-4 w-full h-full"></div>         <div className="relative col-span-1 w-full h-full flex justify-center items-center">
         ...
         <div className="col-span-4 w-full h-full ">
            <div className="w-full h-full bg-blue-600 rounded-md p-2 md:pl-4">                 <h1 className="text-white text-xl font-medium py-2">sindabad-it-solution</h1>
                <p className="text-gray-100 sm:text-sm text-xs">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt corporis consequuntur voluptate nulla iusto quam ut quasi, eaque quas omnis vero totam ullam, reprehenderit ratione pariatur accusamus suscipit odit nostrum?</p>
             </div>
         </div>
