  ...
  return (
    <section id="contact" className=" p-6 bg-white  overflow-hidden">
      <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
        ...
        <form data-aos="fade-left" onSubmit={sendEmail} className="lg:w-2/6 md:w-1/2 bg-slate-600 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
          ...
          <div className="relative mb-4">
            ...
            <input type="text" required name="subject" className="w-full bg-white rounded border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
          </div>
          <div className="relative mb-4">
          ...
          <input type="submit" className="text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-700 rounded text-lg" value="Send" />
